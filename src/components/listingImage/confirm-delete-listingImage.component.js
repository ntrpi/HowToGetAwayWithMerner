...
export default class ConfirmDeleteListingImage extends Component
{
    ...
    componentDidMount()
    {
        ...
        axios.get( 'http://localhost:4000/listingImages/confirm-delete/' + this.state.listingImageId )
            .then( response =>
            {
    ...
    onSubmit( e )
    {
        ...
        axios.post( 'http://localhost:4000/listingImages/delete/' + this.state.listingImageId, listingImage )
